...
import type { DBConnection } from 'node-pg-migrate/dist/db';
import MigrationBuilder from 'node-pg-migrate/dist/migrationBuilder';
import type { ColumnDefinitions } from 'node-pg-migrate/dist/operations/tables/index';
import type { Logger, MigrationAction, MigrationBuilderActions, MigrationDirection, RunnerOption } from 'node-pg-migrate/dist/types';
